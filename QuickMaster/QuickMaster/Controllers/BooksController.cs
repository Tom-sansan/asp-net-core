...
namespace QuickMaster.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Price,Publisher,Sample")] Books books)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Price,Publisher,Sample")] Books books)
        {
            if (id != books.Id)
            {
                return NotFound();
